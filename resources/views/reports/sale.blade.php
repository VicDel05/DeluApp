    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div id="venta-{{ $venta->id }}" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <div class="flex justify-center mt-5">
                <button onclick="descargarDetalle({{ $venta->id }})" class="bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-3 px-5 rounded-lg shadow-md transition-transform transform hover:scale-105">
                    Descargar Detalle
                </button>
            </div>
        </div>
